...
module.exports = "<div class=\"angular-navbar\">\n  <!-- Desktop Horizontal Navbar -->\n  <div class=\"angular-navbar__desktop\" ng-class=\"{'angular-navbar__desktop--always-show':\n      $ctrl.navbarRouteService.alwaysDesktop,\n      'angular-navbar__desktop--always-hide':\n        $ctrl.navbarRouteService.alwaysMobile}\">\n    <!-- Title -->\n    <div ng-if=\"$ctrl.navbarRouteService.title &&\n      !$ctrl.navbarRouteService.titleRoute\" class=\"angular-navbar__desktop__title\">\n      {{$ctrl.navbarRouteService.title}}\n    </div>\n\n    <!-- Title Route -->\n    <div ng-if=\"$ctrl.navbarRouteService.titleRoute\" class=\"angular-navbar__desktop__title--route\"\n      ng-click=\"$ctrl.goToState($ctrl.navbarRouteService.titleRoute)\">\n      {{$ctrl.navbarRouteService.title}}\n    </div>\n\n    <ul class=\"angular-navbar__desktop__list\">\n      <li ng-repeat=\"route in $ctrl.navbarRouteService.getRoutes()\" ng-click=\"$ctrl.goToState(route)\"\n        class=\"angular-navbar__desktop__list__item\"\n        ng-class=\"{'angular-navbar__desktop__list__item--active': $ctrl.isActive(route)}\">\n        {{route.title}}\n      </li>\n    </ul>\n    <ul class=\"angular-navbar__desktop__dropdown\">\n      <li class=\"angular-navbar__desktop__dropdown__item\">\n        <a class=\"angular-navbar__desktop__dropdown__item__title\">Options</a>\n        <ul class=\"angular-navbar__desktop__dropdown__item__menu\">\n          <li class=\"angular-navbar__desktop__dropdown__item__menu__item\">\n            option 1\n          </li>\n          <li class=\"angular-navbar__desktop__dropdown__item__menu__item\">\n            option 2\n          </li>\n        </ul>\n      </li>\n    </ul>\n\n    <ul class=\"angular-navbar__desktop__dropdown\">\n      <li class=\"angular-navbar__desktop__dropdown__item\">\n        <a class=\"angular-navbar__desktop__dropdown__item__title\">Status</a>\n        <ul class=\"angular-navbar__desktop__dropdown__item__menu\">\n          <li class=\"angular-navbar__desktop__dropdown__item__menu__item\">\n            status 1\n          </li>\n          <li class=\"angular-navbar__desktop__dropdown__item__menu__item\">\n            status 2\n          </li>\n        </ul>\n      </li>\n    </ul>\n\n    <div class=\"angular-navbar__desktop__actions\">\n      <button class=\"angular-navbar__desktop__actions__logout\">Logout</button>\n    </div>\n  </div>\n\n  <!-- Mobile Sidenav bar -->\n  <div class=\"angular-navbar__mobile\" ng-class=\"{'angular-navbar__mobile--always-show':\n    $ctrl.navbarRouteService.alwaysMobile,\n    'angular-navbar__mobile--always-hide':\n      $ctrl.navbarRouteService.alwaysDesktop}\">\n\n    <!-- Hamburger menu button -->\n    <div class=\"angular-navbar__mobile__hamburger\" ng-click=\"$ctrl.showNav = true\">\n      <div class=\"angular-navbar__mobile__hamburger__bar\">\n      </div>\n      <div class=\"angular-navbar__mobile__hamburger__bar\">\n      </div>\n      <div class=\"angular-navbar__mobile__hamburger__bar\">\n      </div>\n    </div>\n\n    <!-- Semi Transparent background -->\n    <div class=\"angular-navbar__mobile__shade\" ng-class=\"{'angular-navbar__mobile__shade--nav-active': $ctrl.showNav}\"\n      ng-click=\"$ctrl.showNav = false\">\n    </div>\n\n    <!-- Sidenav that slides in -->\n    <div class=\"angular-navbar__mobile__sidenav\"\n      ng-class=\"{'angular-navbar__mobile__sidenav--nav-active': $ctrl.showNav}\">\n\n      <!-- Title -->\n      <div ng-if=\"$ctrl.navbarRouteService.title &&\n        !$ctrl.navbarRouteService.titleRoute\" class=\"angular-navbar__mobile__sidenav__title\">\n        {{$ctrl.navbarRouteService.title}}\n      </div>\n\n      <!-- Title Route -->\n      <div ng-if=\"$ctrl.navbarRouteService.titleRoute\" class=\"angular-navbar__mobile__sidenav__title--route\"\n        ng-click=\"$ctrl.goToState($ctrl.navbarRouteService.titleRoute)\">\n        {{$ctrl.navbarRouteService.title}}\n      </div>\n\n      <ul class=\"angular-navbar__mobile__sidenav__list\">\n        <li ng-repeat=\"route in $ctrl.navbarRouteService.getRoutes()\" ng-click=\"$ctrl.goToState(route)\"\n          class=\"angular-navbar__mobile__sidenav__list__item\"\n          ng-class=\"{'angular-navbar__mobile__sidenav__list__item--active': $ctrl.isActive(route)}\">\n          {{route.title}}\n        </li>\n      </ul>\n    </div>\n  </div>\n</div>";
